<p align="center">
    <img src="Documentation/Screenshots/Banner.png" alt="Annapoorna Wholesale Gift Shop Banner"/>
</p>
...
This will allow shop staff to quickly identify a customer's reservation when they visit the physical shop.

📦 Order Status

The application supports different reservation/order statuses.
...
Do not upload your real database connection string, SQL Server credentials, passwords or other sensitive configuration values to a public GitHub repository.
...
All project screenshots are available inside:

Documentation/Screenshots/

The documentation contains 13 application screenshots plus the project banner.

🏠 Customer Website Screenshots
01 — Homepage
...
Make sure the screenshot filenames in this README exactly match the files stored in Documentation/Screenshots/.
...
The demonstration video will show the complete customer reservation workflow and Admin Panel management workflow.
